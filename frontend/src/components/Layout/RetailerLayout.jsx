...
const navItems = [
  { to: '/retailer', icon: MdDashboard, label: 'Dashboard', exact: true },
  { to: '/retailer/catalog', icon: MdStorefront, label: 'Katalog Produk' },
  { to: '/retailer/orders', icon: MdListAlt, label: 'Pesanan Saya' },
]
    ...
    <div className="relative z-10 p-3 border-t border-teal-700/50">
      <div className="flex items-center gap-3 p-3 rounded-xl bg-teal-800/50 backdrop-blur-sm mb-2 border border-teal-600/30">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="text-teal-200 text-xs">Retailer</p>
        </div>
      </div>
      <button
        onClick={onLogout}
...
const RetailerLayout = () => {
  ...
  useEffect(() => {
    const prefetch = () => {
      import('../../pages/Retailer/Dashboard')
      import('../../pages/Retailer/Catalog')
      import('../../pages/Retailer/MyOrders')
      import('../../pages/Retailer/Tracking')
    }
